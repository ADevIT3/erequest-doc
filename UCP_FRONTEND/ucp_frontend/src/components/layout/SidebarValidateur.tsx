...
export function AppSidebarValidateur() {
    ...
    useEffect(() => {
        const getEtats = async () => {
            ...
            console.log(etats);
            if (localStorage.getItem("validateur") == "1"){
    ...
    const fetchEtats = async () => {
        ...
        try {
            const res = await axios.get("/requete/etats/validateur", {
    ...
    const fetchEtatsJustif = async () => {
        ...
        try {
            const res = await axios.get("/justificatif/etats_justifs/validateur", {
                withCredentials: true
            });
            console.log(res.data);
                                                            ...
                                                            {subItem.subItems ? (
                                                                                ...
                                                                                <SidebarMenuItem key={subItem2.title}>
                                                                                    ...
                                                                                    >
                                                                                        <Link to={subItem2.url}>
                                                                                            {/*<subItem2.icon />*/}
                                                                                            {subItem2.etat != null ?
                                                                                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", width: "100%" }}><div>{subItem2.title} </div><div style={{ backgroundColor: "gray", width: "25px", height: "25px", borderRadius: "20px", textAlign: "center", alignContent: "center", marginLeft: "auto", color: "white" }}>{subItem2.etat}</div></div>
                                                                ...
                                                                >
                                                                    <Link to={subItem.url}>
                                                                        {/*<subItem.icon />*/}
                                                                            {subItem.etat != null ?
                                                                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "center", alignItems: "center", width: "100%" }}><div>{subItem.title} </div><div style={{ backgroundColor: "gray", width: "20px", height: "20px", borderRadius: "20px", textAlign: "center", alignContent: "center", marginLeft: "auto", color: "white" }}>{subItem.etat}</div></div>
                                                                                : <span>{subItem.title}</span>}
                                                                    </Link>
                                                                </SidebarMenuButton>
                                                            )}

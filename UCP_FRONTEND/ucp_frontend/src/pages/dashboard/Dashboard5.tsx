...
const MultiSelectDropdown: React.FC<{
    ...
    // ... (Les interfaces ProjetDTO, SiteDTO, FiltresDTO et le composant MultiSelectDropdown restent les mêmes que dans Dashboard2)
    return (
...
const Dashboard5: React.FC = () => {
    const [requetes, setRequetes] = useState<Tdb5RequeteDTO[]>([]);
    ...
    // ... (Les fonctions fetchProjets, fetchSites, handleFilterChange, handleProjetSelectionChange, 
    // handleSiteSelectionChange, prepareFiltresForApi, handleDateChange, handleSubmitFilters, 
    // clearFilters et formatDate restent les mêmes que dans Dashboard2)
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.post<Tdb5RequeteDTO[]>(
                '/Bord/tdb5requete',
                    ...
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbPage className="text-gray-700 font-medium">
                                Liste des requêtes non justifiées
                            </BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>

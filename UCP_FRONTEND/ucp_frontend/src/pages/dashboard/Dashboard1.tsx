                                    ...
                                    {requetes.length === 0 ? (
                                        ...
                                        requetes.map((requete, index) => (
                                            <TableRow key={index} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{requete.dateSoumission}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{requete.demandeur}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm font-medium text-gray-900">{requete.montant}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm">{getStatusBadge(requete.statut)}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{requete.dateFinExecution}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{requete.dateFinEcheance}</TableCell>
                                            </TableRow>
                                        ))
                                    )}
                                </TableBody>

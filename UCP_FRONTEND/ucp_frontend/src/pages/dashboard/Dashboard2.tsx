...
const Dashboard2: React.FC = () => {
    const [justificatifs, setJustificatifs] = useState<Tdb2JustifDTO[]>([]);
    ...
    const fetchData = async () => {
        ...
        try {
            const response = await axios.post<Tdb2JustifDTO[]>(
                '/Bord/tdb2justificatif',
                    ...
                    <BreadcrumbList>
                        <BreadcrumbItem>
                            <BreadcrumbPage className="text-gray-700 font-medium">
                                Situation globale des justificatifs
                            </BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
                ...
                <div className="bg-white rounded-sm shadow-sm border border-gray-200 p-6">
                    <div className="flex items-center justify-between mb-6">
                        <h2 className="text-xl font-semibold text-gray-900">
                            Résultats ({justificatifs.length})
                        </h2>
                    </div>
                            ...
                            <Table className="min-w-full bg-white border border-gray-200">
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead className="py-3 px-4 text-left">Numéro justificatif</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Numéro requête</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Objet</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Date saisie</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Demandeur</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Montant</TableHead>
                                        <TableHead className="py-3 px-4 text-left">Statut</TableHead>
                                    ...
                                    {justificatifs.length === 0 ? (
                                        ...
                                        justificatifs.map((justif, index) => (
                                            <TableRow key={index} className="hover:bg-gray-50 transition-colors">
                                                <TableCell className="py-4 px-4 text-sm font-medium text-gray-900">{justif.projetName}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm font-medium text-gray-900">{justif.siteName}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.numeroJustif}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.numeroRequete}</TableCell>
                                                <TableCell
                                                ...
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.dateSaisie}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.demandeur}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm font-medium text-gray-900">{justif.montant}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm">{getStatusBadge(justif.statut)}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.dateFinExecution}</TableCell>
                                                <TableCell className="py-4 px-4 text-sm text-gray-600">{justif.dateFinEcheance}</TableCell>
                                            </TableRow>
                                        ))
                                    )}
                                </TableBody>

                        ...
                        {categorieToColonneList.map((item, idx) => (
                            <div className="grid grid-cols-5 gap-4 items-center mb-2" key={idx}>
                                ...
                                <Select
                                    ...
                                    isClearable
                                    options={[
                                        { value: "depart1", label: "Ville de départ" },
                                        { value: "arrivee1", label: "Ville d'arrivée" },
                                        { value: "distance1", label: "Distance calculée" },
                                    ]}
                                    value={[
                                        { value: "depart1", label: "Ville de départ" },
                                        { value: "arrivee1", label: "Ville d'arrivée" },
                                        { value: "distance1", label: "Distance calculée" },
                                    ].find(opt => opt.value === item.role) || null}
                                    onChange={(opt) => updateCategorieToColonne(idx, "role", opt?.value || "")}
                                />
                                        ...
                                        <div>
                                            ...
                                            <Select
                                                ...
                                                value={[
                                                    ...
                                                    { value: "arrivee1", label: "Ville d'arrivée" },
                                                    { value: "distance1", label: "Distance calculée" },
                                                ].find(opt => opt.value === columnToEdit.role) || null}
                                                onChange={(opt) =>
                                                    setColumnToEdit({ ...columnToEdit, role: opt?.value || null })
                                                }
                                            />
                                        </div>

...
const ListeRequeteManquePj: React.FC = () => {
    ...
    const fetchNbRequetesInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                const res = await axios.get("/Requete/refusees/pages", {
                    withCredentials: true
                });
            ...
            try {
                const res = await axios.get("/Requete/refusees/word/" + debouncedSearchTerm + "/pages", {
                    withCredentials: true
                });
                setTotalItems(res.data);
    ...
    const fetchRequetesInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                console.log("/Requete/refusees/page/" + currentPage);
                const res = await axios.get<Requete[]>("/Requete/refusees/page/" + currentPage, {
                    withCredentials: true
                });
                setRequetesInitiees(res.data);
            ...
            try {
                console.log("/Requete/refusees/word/" + debouncedSearchTerm + "/page/" + currentPage);
                const res = await axios.get<Requete[]>("/Requete/refusees/word/" + debouncedSearchTerm + "/page/" + currentPage, {
                    withCredentials: true
                });

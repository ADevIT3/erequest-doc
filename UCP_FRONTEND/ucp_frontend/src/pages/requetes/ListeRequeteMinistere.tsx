...
const RequetesPageMinistere: React.FC = () => {
    ...
    const fetchNbRequetesVm = async () => {
        setLoading(true);
        setError(null);
        if (debouncedSearchTerm == "") {
            try {
                const res = await axios.get("/Requete/v_ministere/pages", {
                    withCredentials: true
                });
            ...
            try {
                const res = await axios.get("/Requete/v_ministere/word/" + debouncedSearchTerm + "/pages", {
                    withCredentials: true
                });
                setTotalItems(res.data);
    ...
    const fetchRequetesVministere = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                console.log("/Requete/v_ministere/page/" + currentPage);
                const res = await axios.get<Requete[]>("/Requete/v_ministere/page/" + currentPage, {
                    withCredentials: true
                });
            ...
            try {
                console.log("/Requete/v_ministere/word/" + debouncedSearchTerm + "/page/" + currentPage);
                const res = await axios.get<Requete[]>("/Requete/v_ministere/word/" + debouncedSearchTerm + "/page/" + currentPage, {
                    withCredentials: true
                });
    ...
    const handleExportCSV = () => {
        ...
        link.setAttribute("download", "requetes_validées_ministère.csv");
    ...
    const handleExportPDF = () => {
        ...
        exportTableToPDF({
            ...
            headers,
            rows,
            fileName: "requetes_validées_ministère.pdf"
        });
    };
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 bg-[#fafafa]">
                ...
                <div className="rounded-sm border bg-card p-4">
                    <div className="ml-auto flex gap-2 items-center">
                        <h2 className="text-lg font-semibold mb-4 px-4 py-4">Requêtes validées par le ministère</h2>
                        <div className="ml-auto flex gap-2 items-center">
                            <input
                            ...
                            <table className="table-auto border-collapse border-none w-full my-4 ">
                                <thead>
                                    <tr className="text-left text-sm">
                                        ...
                                        <th className="border-b font-bold text-black text-xs">Début d'éxécution</th>
                                        <th className="border-b font-bold text-black text-xs">Fin d'éxécution</th>

                                        <th className="border-b font-bold text-black text-xs">Fin d'échéance</th>
...
export default RequetesPageMinistere; 
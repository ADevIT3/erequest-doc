...
const JustifInities: React.FC = () => {
    ...
    const fetchNbJustifsInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                const res = await axios.get("/Justificatif/initiees/pages", {
                    withCredentials: true
                });
            ...
            try {
                const res = await axios.get("/Justificatif/initiees/word/" + debouncedSearchTerm + "/pages", {
                    withCredentials: true
                });
                setTotalItems(res.data);
                console.log(res.data);
    ...
    const fetchJustifsInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                ...
                const res = await axios.get<Justificatif[]>("/Justificatif/initiees/page/" + currentPage, {
                    withCredentials: true
                });
                setJustifInitiees(res.data);
            ...
            try {
                ...
                const res = await axios.get<Justificatif[]>("/Justificatif/initiees/word/" + debouncedSearchTerm + "/page/" + currentPage, {
                    withCredentials: true
                });

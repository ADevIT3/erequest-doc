...
import { FileText, Loader2, FilePenLine, Upload, Trash2, Eye, User } from "lucide-react";
import {
    Tooltip,
    TooltipContent,
    TooltipProvider,
...
const JustifAreviser: React.FC = () => {
    ...
    const fetchNbJustifsInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                const res = await axios.get("/Justificatif/a_reviser/pages", {
                    withCredentials: true
                });
                ...
                setError("Erreur lors du chargement des justificatifs");
            ...
            try {
                const res = await axios.get("/Justificatif/a_reviser/word/" + debouncedSearchTerm + "/pages", {
                    withCredentials: true
                });
                setTotalItems(res.data);
                console.log(res.data);
    ...
    const fetchJustifsInitiees = async () => {
        ...
        if (debouncedSearchTerm == "") {
            try {
                console.log("/Justificatif/initiees/page/" + currentPage);
                const res = await axios.get<Justificatif[]>("/Justificatif/a_reviser/page/" + currentPage, {
                    withCredentials: true
                });
                setJustifInitiees(res.data);
            ...
            try {
                console.log("/Justificatif/initiees/word/" + debouncedSearchTerm + "/page/" + currentPage);
                const res = await axios.get<Justificatif[]>("/Justificatif/a_reviser/word/" + debouncedSearchTerm + "/page/" + currentPage, {
                    withCredentials: true
                });
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 bg-[#fafafa]">
                ...
                <div className="rounded-sm border bg-card p-4">
                    {/*<div className="ml-auto flex gap-2 items-center">
                        <h2 className="text-lg font-semibold mb-4 px-4 py-4">Justificatifs initiés</h2>
                        <div className="ml-auto flex gap-2 items-center">
                            <input
                    ...
                    <div className="ml-auto flex gap-2 items-center">
                        <h2 className="text-lg font-semibold mb-4 px-4 py-4">Justificatifs à reviser</h2>
                        <div className="ml-auto flex gap-2">
                                    ...
                                    {justifInitiees.length === 0 ? (
                                        ...
                                        justifInitiees.map((justif) => (
                                            <tr key={justif.idJustif} className="hover:bg-gray-100 cursor-pointer">
                                                ...
                                                <td className="border-b  py-2 text-xs text-zinc-500">{justif.commentaireRevision}</td>

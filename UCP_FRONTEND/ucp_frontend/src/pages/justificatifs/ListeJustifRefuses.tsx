...
import { Loader2, User, FileText, Upload, Trash2, Eye, Search } from "lucide-react";
...
const JustifRefuses: React.FC = () => {
    ...
    const fetchNbJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = "/Justificatif/refuses/pages";

            // Si on a un terme de recherche, utiliser l'endpoint de recherche
            if (debouncedSearchTerm.trim() !== "") {
                url = `/Justificatif/refuses/word/${encodeURIComponent(debouncedSearchTerm)}/pages`;
            }
    ...
    const fetchJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = `/Justificatif/refuses/page/${currentPage}`;

            // Si on a un terme de recherche, utiliser l'endpoint de recherche
            if (debouncedSearchTerm.trim() !== "") {
                url = `/Justificatif/refuses/word/${encodeURIComponent(debouncedSearchTerm)}/page/${currentPage}`;
            }
        ...
        <>
            ...
            <div className="flex flex-1 flex-col gap-4 p-4 bg-[#fafafa]">
                ...
                <div className="rounded-sm border bg-card p-4">
                    {/*<h2 className="text-lg font-semibold mb-4 px-4 py-4">Justificatifs refusés</h2>

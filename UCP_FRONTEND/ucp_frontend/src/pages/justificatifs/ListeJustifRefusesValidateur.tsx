...
const JustifRefusesValidateur: React.FC = () => {
    ...
    const fetchNbJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = url1+"/refuses/pages";
            if (debouncedSearchTerm.trim() !== "") {
                url = url1+`/refuses/word/${encodeURIComponent(debouncedSearchTerm)}/pages`;
            }
    ...
    const fetchJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = url1+`/refuses/page/${currentPage}`;
            if (debouncedSearchTerm.trim() !== "") {
                url = url1+`/refuses/word/${encodeURIComponent(debouncedSearchTerm)}/page/${currentPage}`;
            }
...
export default JustifRefusesValidateur; 
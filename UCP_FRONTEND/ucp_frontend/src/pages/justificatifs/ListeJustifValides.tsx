...
const JustifValides: React.FC = () => {
    ...
    const fetchNbJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = "/Justificatif/valides/pages";

            // Si on a un terme de recherche, utiliser l'endpoint de recherche
            if (debouncedSearchTerm.trim() !== "") {
                url = `/Justificatif/valides/word/${encodeURIComponent(debouncedSearchTerm)}/pages`;
            }
    ...
    const fetchJustifsInitiees = async () => {
        ...
        setError(null);
        try {
            let url = `/Justificatif/valides/page/${currentPage}`;

            // Si on a un terme de recherche, utiliser l'endpoint de recherche
            if (debouncedSearchTerm.trim() !== "") {
                url = `/Justificatif/valides/word/${encodeURIComponent(debouncedSearchTerm)}/page/${currentPage}`;
            }

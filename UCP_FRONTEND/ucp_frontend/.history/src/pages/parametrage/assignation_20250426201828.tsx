...
const AssignationPage: React.FC = () => {
  ...
  const [colonnes] = useState<Colonne[]>([
    { id: 1, categorieId: 1, nom: "Colonne 1", typeDonnee: 'text' },
    { id: 2, categorieId: 1, nom: "Colonne 2", typeDonnee: 'nombre' }
  ]);
      ...
      <SidebarInset>
        ...
        <div className="flex flex-1 flex-col gap-4 p-4">
          <div className="rounded-lg border bg-card p-4">
            ...
            {/* Section Assignation Type => Catégorie */}
            <div className="mb-6">
            ...
            {/* Section Assignation Catégorie => Rubrique */}
            <div className="mb-6">
            ...
            {/* Section Assignation Catégorie => Colonne */}
            <div>
